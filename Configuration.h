...
#define STRING_CONFIG_H_AUTHOR "(Arno Juan, Prusa I3 with MKS Gen V1.4)" // Who made the changes.
...
// 步進馬達步進角1.8度，晶片驅動16微步
// 表示轉一圈需要(360/1.8)*16=3200步
// 此軸擠出1mm需要3200/34.54=92.646步
// 公式:(3200*擠出機齒輪比)/(pi*擠出齒輪直徑)

// 步進馬達1.3A，A4988晶片 Rs=0.1Ω、電流上限2A，Vref應設定成1.6V
// (1.4/0.7)*8*0.1Ω = 1.6V
